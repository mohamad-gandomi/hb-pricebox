...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \HB_Price_Box\Plugin The single instance of the class.
	 */
	 ...
	 * @access public
	 * @static
	 * @return \HB_Price_Box\Plugin An instance of the class.
	 */
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/pricebox.php' );

		$widgets_manager->register( new \HB_Price_Box\Widgets\Elementor_Price_Box_Widget() );
	...
	public function register_controls( $controls_manager ) {
		...
		$controls_manager->register( new \HB_Price_Box\Control_1() );
